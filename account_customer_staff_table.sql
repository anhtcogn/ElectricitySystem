...
INSERT INTO customer (`meter_code`,`address`,`email`,`gender`,`name`,`phone_number`,`id`) VALUES ('PAC001','10 Trần Phú, Mộ Lao, Hà Đông','hoangvananh7201@gmail.com',1,'Hoàng Vân Anh','0961082342','HD11300001');
INSERT INTO customer (`meter_code`,`address`,`email`,`gender`,`name`,`phone_number`,`id`) VALUES ('PAC002','12 Nguyễn Văn Lộc, Mộ Lao, Hà Đông','hoangthuhien@gmail.com',1,'Hoàng Thu Hiền','0679823541','HD11300002');
INSERT INTO customer (`meter_code`,`address`,`email`,`gender`,`name`,`phone_number`,`id`) VALUES ('PAC003','82 Lê Lai, Hà Cầu, Hà Đông','nguyenvanquang@gmail.com',0,'Nguyễn Văn Quân','0967453276','HD11300003');
INSERT INTO customer (`meter_code`,`address`,`email`,`gender`,`name`,`phone_number`,`id`) VALUES ('PAC004','17 Thanh Bình, Vạn Phúc, Hà Đông','doanvanbach@gmail.com',0,'Đoàn Văn Bách','0367854312','HD11300004');
INSERT INTO customer (`meter_code`,`address`,`email`,`gender`,`name`,`phone_number`,`id`) VALUES ('PAC005','27 Lê Trọng Tấn, Quang Trung, Hà Đông','nguyenngocanh@gmail.com',1,'Nguyễn Ngọc Ánh','0946719823','HD11300005');
INSERT INTO customer (`meter_code`,`address`,`email`,`gender`,`name`,`phone_number`,`id`) VALUES ('PAC006','368 Quang Trung, Quang Trung, Hà Đông','tranngocanh@gmail.com',1,'Trần Thị Ngọc Anh','0786820123','HD11300006');
INSERT INTO customer (`meter_code`,`address`,`email`,`gender`,`name`,`phone_number`,`id`) VALUES ('PAC007','68 La Khê, Văn Khê, Hà Đông','phamducbinh@gmail.com',0,'Phạm Đức Bình','0986723198','HD11300007');
